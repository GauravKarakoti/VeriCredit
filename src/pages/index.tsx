...
const MainPage: NextPageWithLayout = () => {
  ...
  return (
    <>
      <NextSeo
        title="VeriCredit | Private Credit Scoring on Aleo"
        description="Prove your creditworthiness. Borrow without collateral. Keep your data private."
      />
      ...
      <div className="fixed inset-0 bg-primary bg-opacity-80 z-10 flex flex-col items-center justify-center px-4 py-16">
        ...
        <p className="mt-4 text-lg text-center text-primary-content max-w-lg">
          Decentralized lending protocol on Aleo enabling undercollateralized loans based on private zero-knowledge credit scores.
        </p>
